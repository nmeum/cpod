...
B<cpod-export> I<URLFILE>

=head1 DESCRIPTION

cpod-export reads the specfied I<URLFILE> line by line, fetches each
...
at cpod-import(1). However, currently the XML document is only written
to stdout after all feeds have been fetched.
